...
@section('subtitle', 'Kelola transaksi pengeluaran')
...
<div class="bg-white rounded-2xl shadow-soft border border-gray-100/50 p-5 mb-6">
    <form action="{{ route('expense.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-6 gap-4">
        <div>
        ...
        <div class="flex items-end gap-2">
            ...
            <a href="{{ route('expense.index') }}" class="px-3 py-2.5 border border-gray-200 text-gray-500 rounded-xl hover:bg-gray-50">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="table-row-hover">
                    ...
                    <td class="py-4 px-6 text-right">
                        <span class="text-sm font-bold text-rose-600">-Rp {{ number_format($trx->amount, 0, ',', '.') }}</span>
                    </td>
                    <td class="py-4 px-6 text-center">
                        <a href="{{ route('expense.show', $trx) }}" class="inline-flex items-center px-3 py-1.5 bg-gray-100 text-gray-600 text-xs font-semibold rounded-lg hover:bg-rose-100 hover:text-rose-700 transition">
                            Lihat
                        </a>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="7" class="py-16 text-center">
                        <div class="flex flex-col items-center">
                            ...
                            <a href="{{ route('expense.create') }}" class="btn-primary inline-flex items-center px-5 py-2.5 text-white font-semibold rounded-xl">
