...
@section('subtitle', 'Catat transaksi pemasukan baru')
    ...
    <div class="bg-white rounded-2xl shadow-soft border border-gray-100/50 overflow-hidden">
        <div class="p-6 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-white">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-800">Data Pemasukan</h2>
                    <p class="text-sm text-gray-400 mt-0.5">Lengkapi informasi transaksi pemasukan</p>
                </div>
            </div>
        </div>
        
        <form action="{{ route('income.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
